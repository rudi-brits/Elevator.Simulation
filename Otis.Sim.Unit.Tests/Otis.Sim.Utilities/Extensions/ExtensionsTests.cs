...
{
    /// <summary>
    /// Class ExtensionsTests extends the <see cref="BaseTestService" /> class.
    /// </summary>
    /// <category><see cref="TestConstants.ExtensionsCategory" /></category>
    [TestFixture(Category = TestConstants.ExtensionsCategory)]
    public abstract class ExtensionsTests : BaseTestService
    {
    }
}
